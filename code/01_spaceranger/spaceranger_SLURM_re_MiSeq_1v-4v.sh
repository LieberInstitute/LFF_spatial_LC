...
#SBATCH --mem=80G
#SBATCH -n 8
#SBATCH -o /dcs05/lieber/marmaypag/LFF_spatialLC_LIBD4140/LFF_spatial_LC/code/01_spaceranger/logs/spaceranger_re_MiSeq_1v-4v_%a.txt
#SBATCH -e /dcs05/lieber/marmaypag/LFF_spatialLC_LIBD4140/LFF_spatial_LC/code/01_spaceranger/logs/spaceranger_re_MiSeq_1v-4v_%a.txt
#SBATCH --array=1-4
...
## Read inputs from spaceranger_parameters_re_MiSeq_1v-4v.txt file
FILE=$(awk "NR==${SLURM_ARRAY_TASK_ID}" spaceranger_parameters_re_MiSeq_1v-4v.txt)
