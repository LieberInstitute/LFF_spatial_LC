...
manlcs <- fread("processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens1_LCsampsonly_featureSelection_dimred_harmony_clustering/07_2_LCsampsonly_manual_expression_defined_LC.txt")
...
save
```{r}
saveRDS(ans2,"processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens1_LCsampsonly_featureSelection_dimred_harmony_clustering/07b_2-manualLCdefs_vs_louvainLC.RDS")
```
