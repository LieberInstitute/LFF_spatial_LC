...
anno <- fread("processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens1_LCsampsonly_featureSelection_dimred_harmony_clustering/08_2-25hdg75svg_louv1_annots_prelim.txt")
...
fwrite(regwraptab2,"processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens2_markers_and_registration_final/03_2-HDGSVG2575louv1_regWrapOut_Oligo_1vOthers_markers.txt",sep="\t",quote=F,row.names=F,col.names=T)
...
regwraptab[,variable:=NULL]
regwraptab2 <- dcast(regwraptab,cluster+gene+ensembl~stat)
fwrite(regwraptab2,"processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens2_markers_and_registration_final/03_2-HDGSVG2575louv1_regWrapOut_Astros_1vOthers_markers.txt",sep="\t",quote=F,row.names=F,col.names=T)
