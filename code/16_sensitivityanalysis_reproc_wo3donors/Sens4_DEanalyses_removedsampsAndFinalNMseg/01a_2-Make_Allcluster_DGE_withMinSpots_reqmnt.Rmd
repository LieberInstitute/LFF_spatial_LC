---
title: "01a_2-Make_Allcluster_DGE_withMinSpots_reqmnt"
...
## Already dropped Br5517 (unknown anatomy/orientation), Br5276 (LC has been depleted by QC), Br5712 (unknown anatomy/orientation) in this version of data/clustering/analysis.
```{r}
...
```{r}
## only retain clusters for which at least 39 samples (of 77 total, i.e over half) of ≥10 spots each are available. do we need to drop any?
check <- as.data.table(table(colData(lc3)[,c("label","sample_id")]))
check <- check[N>=10]
check[,.N,by="label"][N<39,label]
# nope
...
check <- as.data.table((colData(lc3)[,c("label","Sex","sample_id")]))[,.N,by=c("Sex","label","sample_id")]
...
## save
```{r}
saveRDS(dgel,"processed-data/12_2_DEanalyses_removedsampsAndFinalNMseg/01a-DGElist_allClust_10spotmin_NOfilt.RDS")
```
...
lapply(covcols2,FUN=function(cov){
  ...
  png(paste0("plots/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/01_pseudobulk_cluster_MDSes/01a_2-Allclust-",cov,"_1_2_LabelModelFilt.png"),width=1000,height=800)
  print(p)
  dev.off()
})
...
lapply(covcols2,FUN=function(cov){
  ...
  png(paste0("plots/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/01_pseudobulk_cluster_MDSes/01a_2-Allclust_",cov,"_1_3_LabelModelFilt.png"),width=1000,height=800)
  print(p)
  dev.off()
})
...
lapply(covcols2,FUN=function(cov){
  ...
  png(paste0("plots/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/01_pseudobulk_cluster_MDSes/01a_2-Allclust-",cov,"_2_3_LabelModelFilt.png"),width=1000,height=800)
  print(p)
  dev.off()
})
...
## lib size is a very srs driver of variance, especially for the multi-cell-type clusters (astro_oligo, oligo_astro, oligo_2, oligo_neuron, vascular).
...
other attached packages:
 ...
 [3] gridExtra_2.3               edgeR_4.8.2                
 [5] dreamlet_1.8.0              variancePartition_1.40.1   
 [7] BiocParallel_1.44.0         limma_3.66.0               
 [9] ggplot2_4.0.2               SpatialExperiment_1.20.0   
...
loaded via a namespace (and not attached):
 ...
 [31] DelayedMatrixStats_1.32.0 codetools_0.2-20          DelayedArray_0.36.0      
...
[103] KEGGgraph_1.70.0          invgamma_1.2              magick_2.9.0             
[106] mvtnorm_1.3-3             cli_3.6.5                 locfit_1.5-9.12          
[109] compiler_4.5.2            rlang_1.1.7               crayon_1.5.3             
[112] SQUAREM_2021.1            labeling_0.4.3            plyr_1.8.9               
[115] ggbeeswarm_0.7.3          stringi_1.8.7             viridisLite_0.4.2        
[118] babelgene_22.9            assertthat_0.2.1          lmerTest_3.2-0           
[121] Biostrings_2.78.0         aod_1.3.3                 Matrix_1.7-4             
[124] hms_1.1.4                 sparseMatrixStats_1.22.0  bit64_4.6.0-1            
[127] KEGGREST_1.50.0           statmod_1.5.1             rbibutils_2.4.1          
[130] Rfast_2.1.5.2             broom_1.0.12              memoise_2.0.1            
[133] RcppParallel_5.1.11-1     bit_4.6.0                 EnrichmentBrowser_2.40.0 
> sessioninfo::session_info()
─ Session info ────────────────────────────────────────────────────────────────────
 setting  value
