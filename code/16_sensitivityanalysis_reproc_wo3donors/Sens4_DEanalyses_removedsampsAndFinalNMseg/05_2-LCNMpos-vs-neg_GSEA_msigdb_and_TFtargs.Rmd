...
```{r}
lcnmde <- fread("processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/04_2-LCNMpos_vs_LCNMneg_DE.txt")
...
```{r}
lcnmde <- fread("processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/04-LCNMpos_vs_LCNMneg_DE.txt")
...
saveRDS(nmgseas,"processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/05_2-LCNMposVsNeg_msigdb_and_tftarg_GSEAs.RDS")
```
