...
lc.nmf2 <- readRDS("processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens3_subclustering_and_NMF/07b-lcnmf120_tol1e-9_rowSumLogctFilt18.RDS")
...
fwrite(w2m.select,"processed-data/16_sensitivityanalysis_reproc_wo3donors/Sens4_DEanalyses_removedsampsAndFinalNMseg/06b_2_LCnmfLogCt18Filt_factors_and_factorSpecGenes_min25specGenes.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
