---
title: "08a-Collate Oterogarcia ctx NFT-assoc genes and get lff cluster xpr props"
...
## the full DE results comparing AD donor AT8+ to AD AT8-, AD AT8+ to ctrl AT8-, and AD AT8- to ctrl AT8- are in a spreadsheet, sheet per cluster.
...
### tabulate and save
```{r}
lc3sub <- lc3[rownames(lc3) %in% keepg,]
...
# save
fwrite(anstab,"processed-data/Xenium_prioritization/08a-ProportionSpots_per_clus_w_Oterogarcia22_multiclust_AT8DEGs.txt",sep='\t',quote=F,row.names=F)
```
