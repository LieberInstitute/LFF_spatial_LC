...
### from the initial sample set (Sept 2023), the following samples had few or no TH+ or DBH+ spots, so we'll remove them for now:
exclude: br5854, br5712, br1691, br2305, br5276,br1039,br5517
```{r}
lc <- readRDS("processed-data/02_build_spe/spe.rds")
colnames(lc) <- lc$key
...
### save
saveRDS(lc2,"processed-data/lc_spe_nomitofilt_200umi-130gene_nonLCsampsdropped_102923.RDS")
```
