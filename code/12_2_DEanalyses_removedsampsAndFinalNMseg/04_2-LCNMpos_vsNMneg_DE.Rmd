...
finalann <- fread("processed-data/07_2_LCsampsonly_featureSelection_dimred_harmony_clustering/08_2-25hdg75svg_louv1_annots.txt")
...
fwrite(nm_detab,"processed-data/12_2_DEanalyses_removedsampsAndFinalNMseg/04_2-LCNMpos_vs_LCNMneg_DE.txt",sep='\t',quote=F,row.names=F,col.names=T)
