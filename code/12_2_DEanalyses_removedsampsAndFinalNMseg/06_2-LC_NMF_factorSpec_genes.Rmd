...
lc.nmf2 <- readRDS("processed-data/10_2_subclustering_and_NMF/07_2-lcnmf120_tol1e-9.RDS")
...
fwrite(w2m.select,"processed-data/12_2_DEanalyses_removedsampsAndFinalNMseg/06_2-LCNMF_factors_and_factorSpecGenes_min25specGenes.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
