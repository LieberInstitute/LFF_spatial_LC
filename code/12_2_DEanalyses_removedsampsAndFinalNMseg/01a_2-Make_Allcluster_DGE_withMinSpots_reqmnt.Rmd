...
lapply(covcols2,FUN=function(cov){
  ...
  png(paste0("plots/12_2_DEanalyses_removedsampsAndFinalNMseg/01_pseudobulk_cluster_MDSes/01a_2-Allclust-",cov,"_1_2_LabelModelFilt.png"),width=1000,height=800)
  print(p)
  dev.off()
})
...
lapply(covcols2,FUN=function(cov){
  ...
  png(paste0("plots/12_2_DEanalyses_removedsampsAndFinalNMseg/01_pseudobulk_cluster_MDSes/01a_2-Allclust_",cov,"_1_3_LabelModelFilt.png"),width=1000,height=800)
  print(p)
  dev.off()
})
...
lapply(covcols2,FUN=function(cov){
  ...
  png(paste0("plots/12_2_DEanalyses_removedsampsAndFinalNMseg/01_pseudobulk_cluster_MDSes/01a_2-Allclust-",cov,"_2_3_LabelModelFilt.png"),width=1000,height=800)
  print(p)
  dev.off()
})
