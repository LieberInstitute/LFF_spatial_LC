---
title: "09aV2-LC_NMF_msigdbAndTFtarg_GSEA"
...
lc.nmf2 <- readRDS("processed-data/10_subclustering/07thru10_ver2_53factorNMF/07-lcnmf53_tol1e-9.RDS")
...
## save
saveRDS(outlist2,"processed-data/10_subclustering/07thru10_ver2_53factorNMF/09aV2-LC_NMF_specificallyLoadedFactors_GSEA_msigdbAndTFtarg.RDS")

## also save our table of factors with 25+ specific genes and which genes go with each
fwrite(w2m.select,"processed-data/10_subclustering/07thru10_ver2_53factorNMF/09aV2-LCNMF_factors_and_factorSpecGenes_min25specGenes.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
