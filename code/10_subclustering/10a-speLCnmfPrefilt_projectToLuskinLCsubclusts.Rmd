---
title: "10a-speLCnmfPrefilt_projectToLuskinLCsubclusts"
...
colnames(colData(mslc))[c(11:ncol(colData(mslc)))] <- paste0("LCspeFiltNMF_",c(1:160))
...
png("plots/10_subclustering/10a-speLCnmfPrefilt_allfactors_projectToLuskinLCsubclusts.png",height=1000,width=8000)
...
png("plots/10_subclustering/10a-speLCnmfPrefilt_GSEAdFactors_projectToLuskinLCsubclusts.png",height=1000,width=1500)
