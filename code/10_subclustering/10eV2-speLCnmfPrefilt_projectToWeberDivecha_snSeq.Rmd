...
png("plots/10_subclustering/07thru10_ver2_53factorNMF/10e-speLCnmfPrefilt_allfactors_projectToWeberDivechaSnseq.png",height=1000,width=8000)
...
## factor 12: astro; 20-oligo; 30-mural and macro/micro; others NE or nothing in particular.
...
png("plots/10_subclustering/07thru10_ver2_53factorNMF/10e-speLCnmfPrefilt_GSEAdFactors_projectToWeberDivechaSnseq.png",height=1000,width=1500)
...
## nice, that clears up a couple that are astrocytic, vascular and/or microglial. 3 and 6 strongly NE.
```
