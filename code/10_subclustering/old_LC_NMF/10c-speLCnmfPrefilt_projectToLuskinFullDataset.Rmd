...
colnames(colData(lca))[c(14:ncol(colData(lca)))] <- paste0("LCspeFiltNMF_",c(1:160))
...
png("plots/10_subclustering/10c-speLCnmfPrefilt_allfactors_projectToLuskinMainClusts.png",height=1000,width=8000)
...
png("plots/10_subclustering/10c-speLCnmfPrefilt_GSEAdFactors_projectToLuskinMainClusts.png",height=1000,width=1500)
