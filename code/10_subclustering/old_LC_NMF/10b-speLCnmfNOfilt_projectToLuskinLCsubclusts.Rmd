...
set.seed(42)
lffprojinto.ms <- RcppML::project(A=logcounts(mslc),w=orthw)#,L2=0.00005)
...
colnames(colData(mslc))[c(11:ncol(colData(mslc)))] <- paste0("LCspeNOfiltNMF_",c(1:160))
...
png("plots/10_subclustering/10b-speLCnmfNOfilt_allfactors_projectToLuskinLCsubclusts.png",height=1000,width=8000)
...
png("plots/10_subclustering/10b-speLCnmfNOfilt_GSEAdFactors_projectToLuskinLCsubclusts.png",height=1000,width=1500)
