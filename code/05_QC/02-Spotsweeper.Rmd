...
## plot em
```{r}
SpotSweeper::plotQCpdf(spe=lc,metric = "sum_umi_log_high",outliers = "sum_umi_outliers_high",point_size = 2,height = 6,width=7,fname="plots/05_QC/02a-Spotsweeper_sumUMI-high_outliers.pdf")
#

SpotSweeper::plotQCpdf(spe=lc,metric = "sum_umi_log_low",outliers = "sum_umi_outliers_low",point_size = 2,height = 6,width=7,fname="plots/05_QC/02b-Spotsweeper_sumUMI-low_outliers.pdf")
#

SpotSweeper::plotQCpdf(spe=lc,metric = "sum_gene_log_high",outliers = "sum_gene_outliers_high",point_size = 2,height = 6,width=7,fname="plots/05_QC/02c-Spotsweeper_sumGene-high_outliers.pdf")

#

SpotSweeper::plotQCpdf(spe=lc,metric = "sum_gene_log_low",outliers = "sum_gene_outliers_low",point_size = 2,height = 6,width=7,fname="plots/05_QC/02d-Spotsweeper_sumGene-low_outliers.pdf")
# 

SpotSweeper::plotQCpdf(spe=lc,metric = "expr_chrM_ratio",outliers = "expr_chrM_ratio_outliers",point_size = 2,height = 6,width=7,fname="plots/05_QC/02e-Spotsweeper_pctMito-high_outliers.pdf")
...
loaded via a namespace (and not attached):
 ...
 [15] rmarkdown_2.27            limma_3.60.3             
 ...
 [37] terra_1.7-78              DelayedMatrixStats_1.26.0
 [39] codetools_0.2-20          DelayedArray_0.30.1      
 [41] xml2_1.3.6                DT_0.33                  
 [43] scuttle_1.14.0            tidyselect_1.2.1         
 [45] farver_2.1.2              UCSC.utils_1.0.0         
 [47] ScaledMatrix_1.12.0       viridis_0.6.5            
 [49] shinyWidgets_0.8.6        BiocFileCache_2.12.0     
 [51] GenomicAlignments_1.40.0  jsonlite_1.8.8           
 [53] escheR_1.4.0              BiocNeighbors_1.22.0     
 [55] scater_1.32.0             iterators_1.0.14         
 [57] foreach_1.5.2             tools_4.4.1              
 [59] Rcpp_1.0.12               glue_1.7.0               
 [61] SparseArray_1.4.8         xfun_0.45                
 ...
 [73] colorspace_2.1-0          RSQLite_2.3.7            
 [75] config_0.3.2              utf8_1.2.4               
 [77] tidyr_1.3.1               generics_0.1.3           
 [79] rtracklayer_1.64.0        httr_1.4.7               
 [81] htmlwidgets_1.6.4         S4Arrays_1.4.1           
 ...
 [93] rjson_0.2.21              curl_5.2.1               
 [95] cachem_1.1.0              BiocVersion_3.19.1       
 [97] parallel_4.4.1            vipor_0.4.7              
 [99] AnnotationDbi_1.66.0      restfulr_0.0.15          
[101] pillar_1.9.0              grid_4.4.1               
...
[111] evaluate_0.24.0           magick_2.8.3             
[113] cli_3.6.2                 locfit_1.5-9.10          
[115] compiler_4.4.1            Rsamtools_2.20.0         
[117] crayon_1.5.3              labeling_0.4.3           
[119] rematch2_2.1.2            spatialEco_2.0-2         
[121] ggbeeswarm_0.7.2          viridisLite_0.4.2        
[123] munsell_0.5.1             lazyeval_0.2.2           
[125] Matrix_1.7-0              ExperimentHub_2.12.0     
[127] benchmarkme_1.0.8         sparseMatrixStats_1.16.0 
[129] bit64_4.0.5               KEGGREST_1.44.1          
[131] statmod_1.5.0             shiny_1.8.1.1            
[133] AnnotationHub_3.12.0      gridtext_0.1.5           
[135] memoise_2.0.1             bslib_0.7.0              
