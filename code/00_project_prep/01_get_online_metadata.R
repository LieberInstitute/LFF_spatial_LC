...
metadata_visium_plan <- read_sheet("https://docs.google.com/spreadsheets/d/1HrGJTORA_9YgfVT7gSxagdZ-27VK8aDksfTnpSCXex4/edit#gid=530593227",
  ...
  fill(Date, `Kit used`, Visium_Slide)
  metadata_visium_plan |> unnest(c(Visium_subslide, Slide_number, Rin, Age))
  #metadata_visium_plan |> unnest(`Slide number`)

colnames(metadata_visium_plan)
# [1] "Date"            "Kit used"        "Visium_Slide"    "Visium_subslide" "Slide_number"    "BrNum"
# [7] "Genotype"        "Age"             "Sex"             "Ancestry"        "Diagnosis"       "Rin"
# [13] "APOE"            "Notes"           "remade_libaries"
...
# > Sys.time()
# [1] "2024-06-06 09:22:47 EDT"
# > proc.time()
# user   system  elapsed
# 35.778    9.131 1183.147
# > options(width = 120)
# > sessioninfo::session_info()
# ─ Session info ───────────────────────────────────────────────────────────────────────────────────────────────────────
# setting  value
...
# spatialLIBD          * 1.17.2      2024-06-05 [1] Github (LieberInstitute/spatialLIBD@e0947a2)
