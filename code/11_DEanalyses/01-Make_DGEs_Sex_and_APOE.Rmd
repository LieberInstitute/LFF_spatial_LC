---
title: "01-Make_DGEs_Sex_and_APOE"
...
# DO NOT include c("V13M06-332_C1s1","V13M06-332_C1s2","V13B23-286_B1s1","V13B23-286_B1s2") : these four samples are crazywild outliers on the MDS plots of pseudobulks
```{r}
ag <- dreamlet::aggregateToPseudoBulk(lc3[,!(lc3$sample_id %in% c("V13M06-332_C1s1","V13M06-332_C1s2","V13B23-286_B1s1","V13B23-286_B1s2"))],sample_id="sample_id",cluster_id = "label",BPPARAM = MulticoreParam(6))
...
save
```{r}
saveRDS(dgels,"processed-data/10_DEanalyses/01-DGElist_per_25HDG75SVGlouv1_cluster_normFilt.RDS")
```
...
[112] ggbeeswarm_0.7.2          stringi_1.8.4             assertthat_0.2.1         
[115] babelgene_22.9            lmerTest_3.1-3            munsell_0.5.1            
[118] Biostrings_2.74.0         aod_1.3.3                 Matrix_1.7-1             
[121] hms_1.1.3                 sparseMatrixStats_1.18.0  bit64_4.5.2              
[124] KEGGREST_1.46.0           statmod_1.5.0             rbibutils_2.3            
[127] Rfast_2.1.0               broom_1.0.7               memoise_2.0.1            
[130] RcppParallel_5.1.9        bit_4.5.0.1               EnrichmentBrowser_2.36.0 
> sessioninfo::session_info()
─ Session info ─────────────────────────────────────────────────────────────────────
 setting  value
