---
title: "03biii-AncestryStratE4vsE2_MsigDB_GSEA"
format: html
...
de2b3 <- de2b$cat_ances$YRIAPOlabel$detabs
...
gseares <- mapply(X=deres,Y=names(deres),SIMPLIFY=FALSE,FUN=function(X,Y){
  register(MulticoreParam())
   ...
   z1[,dir:=gsub(Y,pattern="^(.*)_vs_(.*)",replacement=paste0("\\1","_up_vs_","\\2"))]
   ...
   z2[,dir:=gsub(Y,pattern="^(.*)_vs_(.*)",replacement=paste0("\\1","_down_vs_","\\2"))]
...
saveRDS(gseares,"processed-data/12_DEanalyses_removedsampsAndFinalNMseg/03biii-MulticlusterDE_AncAPOgroups_dropMixClusts_GSEAmsigdb.RDS")
...
saveRDS(gseares.unsign,"processed-data/12_DEanalyses_removedsampsAndFinalNMseg/03biii-MulticlusterDE_AncAPOgroups_dropMixClusts_GSEAmsigdb_UNsigned.RDS")
```
...
other attached packages:
 ...
 [4] parallelly_1.43.0      default_1.0.0          colorout_1.3-0.2      
 [7] msigdbr_10.0.1         fgsea_1.32.4           clusterProfiler_4.14.6
[10] data.table_1.17.4      rlang_1.1.5           
...
loaded via a namespace (and not attached):
 ...
 [73] locfit_1.5-9.12         babelgene_22.9          fs_1.6.6               
...
[100] httr_1.4.7              here_1.0.1              statmod_1.5.0          
[103] GO.db_3.20.0            bit64_4.6.0-1          
> sessioninfo::session_info()
─ Session info ──────────────────────────────────────────────────────────────────────────────
 setting  value
