---
title: "06b-LC_NMFLogCt18Filt_msigdbAndTFtarg_GSEA"
...
lc.nmf2 <- readRDS("processed-data/10_subclustering/07b-lcnmf160_tol1e-9_rowSumLogctFilt18.RDS")
...
## save
saveRDS(outlist2,"processed-data/12_DEanalyses_removedsampsAndFinalNMseg/06b-LC_NMFLogCt18Filt_specificallyLoadedFactors_GSEA_msigdbAndTFtarg.RDS")

## also save our table of factors with 25+ specific genes and which genes go with each
fwrite(w2m.select,"processed-data/12_DEanalyses_removedsampsAndFinalNMseg/06b-LCNMFLogCt18Filt_factors_and_factorSpecGenes_min25specGenes.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
