---
title: "01a-Make_Allcluster_DGE_withMinSpots_reqmnt_edgeRdefaultLoExpFilt"
...
## make the single DGEList; added 5/12/25-filter using edgeR default, with grouping by label.
```{r}
...
### for now, we will filter on a model-wise basis in downstream scripts.
# des <- model.matrix(~0+label*Sex+label*APOE+label*YRI+Age,data=dgel$samples)
