...
```{r}
unfilt <- fread("processed-data/12_2_DEanalyses_removedsampsAndFinalNMseg/06_2-LCNMF_factors_and_factorSpecGenes_min25specGenes.txt")

filt <- fread("processed-data/12_2_DEanalyses_removedsampsAndFinalNMseg/06b_2_LCnmfLogCt18Filt_factors_and_factorSpecGenes_min25specGenes.txt")
...
nmf <- readRDS("processed-data/10_2_subclustering_and_NMF/07_2-lcnmf120_tol1e-9.RDS")
nmfbg <- rddt[ensembl_gene_id %in% rownames(nmf$w)&entrezgene_accession!="",unique(entrezgene_accession)]
rm(nmf)

nmffilt <- readRDS("processed-data/10_2_subclustering_and_NMF/07b-lcnmf120_tol1e-9_rowSumLogctFilt18.RDS")
...
saveRDS(unfilt.res2,"processed-data/10_2_subclustering_and_NMF/09_2-LCnmfUNfilt_factorSpecGenes_enrichr_results.RDS")
###
```
...
saveRDS(filt.res2,"processed-data/10_2_subclustering_and_NMF/09_2-LCnmfFilt_factorSpecGenes_enrichr_results.RDS")
```
