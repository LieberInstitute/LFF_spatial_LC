...
annots <- fread("processed-data/07_2_LCsampsonly_featureSelection_dimred_harmony_clustering/08_2-25hdg75svg_louv1_annots.txt")
...
fwrite(cdout,"processed-data/10_2_subclustering_and_NMF/04-LCsubclus-by-NM_otherclusts-by-LCorLCNMadjacency.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
