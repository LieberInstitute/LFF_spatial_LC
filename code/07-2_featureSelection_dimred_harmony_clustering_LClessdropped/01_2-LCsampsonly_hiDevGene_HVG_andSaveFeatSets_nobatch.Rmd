...
fwrite(hvgtab,"processed-data/07_2_LCsampsonly_featureSelection_dimred_harmony_clustering/01a_2_LCsampsonly_TopHVGs_prop1.0_nobatch.txt",sep='\t',quote=F)
...
fwrite(nnsvgranks2,"processed-data/07_2_LCsampsonly_featureSelection_dimred_harmony_clustering/01c_2-LCsampsonly_nnsvg_s2n2_nobatch_meangeneranks.txt",sep='\t',quote=F)
...
# save
saveRDS(featlist,"processed-data/07_2_LCsampsonly_featureSelection_dimred_harmony_clustering/01d_2_LCsampsonly_HiDevG_HVG_SVG_andmixed_featsets.RDS")
```
