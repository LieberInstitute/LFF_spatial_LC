...
dgehittabs[[3]] <- fread("processed-data/11_DEanalyses/03d-Sex_DE_E4alleleCountCovar_FDRunder0.2_byGene_byNmodelsOf4max_byCluster.txt")
dgehittabs[[4]] <- fread("processed-data/11_DEanalyses/03e-Sex_DE_E4alleleCountCovar_unadjP.05_byGene_byNmodelsOf4max_byCluster.txt")
...
```{r}
deres <- readRDS("processed-data/11_DEanalyses/03a-E4andSexDE_with_e4alleleCountModel_toptabs_testsWithandWithout_RINandorAncestry.RDS")
...
# 549 genes-cluster pairs, and we don't have to drop any clusters.
