...
# 1389. still a lot. also set a threshold of log2FC 0.75 in at least one of the tests
# load the DE result object to get the log2FC values
```{r}
deres <- readRDS("processed-data/11_DEanalyses/02a-DEtoptabs_testsWithandWithout_RINandorAncestry.RDS")
...
# 663 genes-cluster pairs, and we don't have to drop any clusters.
