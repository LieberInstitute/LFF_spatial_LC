---
title: "02a-Boxplot_top_APOE_andor_sex_DEGs"
...
pdf("plots/11_DEanalyses/02_geneplots/E4_DE_3plusmodels_FDR0.2_boxplots.pdf",height=length(apoplot)*4,width=9)
...
for (i in c(1:length(sexplots))){
    pdf(paste0("plots/11_DEanalyses/02_geneplots/",names(sexplots)[i],"_Sex_DE_FDR0.2_boxplots.pdf"),height=length(sexplots[[i]])*4,width=9)
