...
for (i in c(1:2)){
    ...
    if(n=="Astro"){
        ...
        pdf(paste0("plots/manuscript/Fig5/5AB-AllE4vsAllE2_Volcano_",n,".pdf"),width=w,height=2,onefile=FALSE)
...
pdf("plots/manuscript/Fig4/4C-LC_allE4vsAllE2_msigdbGSEA.pdf",height=4,width=4.25)
...
### 3DE: Ancestry-E4E2 comparisons (logFCs colored by signif)
```{r}
detabs <- readRDS("processed-data/12_DEanalyses_removedsampsAndFinalNMseg/02b-voomLmFit_objs_and_DE_tables_LabSex_LabE2vE4_LabSingleGenos_LabAnces_LabAncesE4E2_noMixClusts_YRIcontAndCat_JUL2025.RDS")
