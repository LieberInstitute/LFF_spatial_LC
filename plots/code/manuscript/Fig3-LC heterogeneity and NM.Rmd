...
## how the shit to plot this..gets very confusing because NM-enriched genes can be TF-suprressed genes and vice versa
ggplot(tfnm,aes(x=-log10(padj),y=tf,color=NES,size=abs(NES),shape=subanno))+geom_point()+scale_color_gradient2(low="blue",mid="gray",high = "red")
```
