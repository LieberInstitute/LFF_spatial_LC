...
saveplt <- function(g){
    ...
    cortest <- cor.test(pltdat$g_xpr,pltdat$Intensity_NM,method="pearson")
    ...
    p <- ggplot(unique(pltdat[nspot>19,.(sample_id,tissueNMscore,meangene,nspot)]),aes(x=meangene,y=tissueNMscore,col=tissueNMscore))+
        scale_color_gradient(low="brown",high="beige")+
        guides(color="none")+
