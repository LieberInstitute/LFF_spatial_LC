...
read in the per-capture SPE and the colData of the filtered SPE
```{r}
...
plt <- vis_grid_clus(spe,clustervar="label",auto_crop = T,point_size = 1.18,return_plots=T,height=3.75,width=3.75,spatial = T,sort_clust = FALSE,image_id = "lowres",alpha=0.5)
...
## saved legend, modified in AI to place as desired withut messing around with other masks etc etc.
