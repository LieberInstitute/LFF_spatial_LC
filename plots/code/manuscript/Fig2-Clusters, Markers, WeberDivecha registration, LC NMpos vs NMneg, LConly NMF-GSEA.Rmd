...
pltdat[,LFF_clus:=factor(LFF_clus,levels=rev(c("Oligo","Astro","*ACHE*, *SERT*, Npep","*ACHE*, *SERT*, LC, WM","LC")))]

## plot and save

pdf("plots/manuscript/Fig2/2D-WeberDivecha_registration.pdf",height=3.5,width=3.5)
