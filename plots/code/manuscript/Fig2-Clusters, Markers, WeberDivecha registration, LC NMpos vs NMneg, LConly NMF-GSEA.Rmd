...
names(pal)[9] <- "Oligo and Other Types Mixed"
names(pal)[5] <- "Astro-Oligo Mixed"
names(pal)[8] <- "Oligo-Astro Mixed"
names(pal)[2] <- "*ACHE*, *SERT*, LC, Oligo Mixed"
names(pal)[3] <- "*ACHE*, *SERT*, Neuropeptide Mixed"

stopifnot(all(names(pal) %in% unique(louvs$anno)))
```
...
pdf("plots/manuscript/Fig2/2F-Lowexpfilt_LCnmf_FactorSpecGene_Enrichr_nmfs156-160dropped_maxAdjP0.2.pdf",height=4,width=4.35)
