...
pdf(paste0("plots/manuscript/Fig6/6AB-AllE4vsAllE2_Volcano_LCandAstro.pdf"),width=5,height=2,onefile=FALSE)
p
dev.off()
...
#pdf("plots/manuscript/Fig6/6C-LC_allE4vsAllE2_msigdbGSEA.pdf",height=4,width=4.25)
pdf("plots/manuscript/Fig6/6C-LC_allE4vsAllE2_msigdbGSEA_v2.pdf",height=4,width=4.25)
ggplot(msiglc,aes(y=pathway,x=-log10(pval),color=NES,size=abs(NES)))+
    geom_point()+
    #scale_color_gradient2(low="red",high="blue")+
    # changed 032026 to
    scale_color_gradient2(low="#009E73",high="#D55E00")+
...
lapply(unique(ancapo2$domain),function(d){
    ...
    pdf(paste0("plots/manuscript/Fig6/6DE-AncestryE4E2_",d,".pdf"),height=2.5,width=3)
    print(p)
    dev.off()
})
```
...
pdf("plots/manuscript/Fig6/6FG-APOAnc_Astro_Overlaps.pdf",height=3,width=3.75)
ggvenn(astde,names(astde),set_name_size = 3,text_size = 2,stroke_size = 0.5)
dev.off()

pdf("plots/manuscript/Fig6/6FG-APOAnc_LC_Overlaps.pdf",height=3,width=3.75)
