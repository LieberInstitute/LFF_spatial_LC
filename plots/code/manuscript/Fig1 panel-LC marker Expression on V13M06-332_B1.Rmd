...
lapply(parmsets,FUN=function(parm){
    ...
    p <- vis_gene(lc3,sampleid="V13M06-332_B1",spatial = T,na_color = NA,auto_crop = T,point_size = 0.7,alpha=0.65,minCount = minlct,geneid = g,multi_gene_method = "z_score",viridis = T,image_id = "hires")+
    ...
    pdf(paste0("plots/manuscript/Fig1/Fig1-",outname,"_V13M06-332_B1.pdf"), height = 2, width = 2.75)
    print(p)
    dev.off()
