...
LEFT OFF AT LINE ~84: IDENTIFIED WHICH GENES TO INDICATE ON NEW VOLCANOS.
...
pal <- pal[c("LC","*ACHE*, *SERT*, LC, Oligo Mixed","Astro, Vascular, Mural")]
names(pal)[2] <- "*ACHE*, *SERT*, LC,<br>Oligo Mixed"
names(pal)[3] <- "Astro, Vascular,<br>Mural"

detabs <- readRDS("processed-data/12_2_DEanalyses_removedsampsAndFinalNMseg/02b_2-voomLmFit_objs_and_DE_tables_LabSex_LabE2vE4_LabSingleGenos_LabAnces_LabAncesE4E2_noMixClusts_YRIcontAndCat_Feb26.RDS")
...
names(detabs)[3] <- "Astro, Vascular,<br>Mural"
## identify genes to be labeled in plots
# LC APOLD1 CHGB PRCP GSTT2B
# astro HSPB8 GASK1B DNAJB1
