...
lapply(names(nonglm),FUN=function(adrn){
   ...
   for (i in c(1:length(cluscols))){
      ...
      pltdat <- merge.data.table(curdr,tmplouvs[,.(rn,get(clus))],by="rn")
      ...
      pdf(paste0("plots/07_featureSelection_dimred_harmony_clustering/04d_init_louvclusts_on_dimreds/",clus,"_on_",adrn,".pdf"),height=13,width=21)
