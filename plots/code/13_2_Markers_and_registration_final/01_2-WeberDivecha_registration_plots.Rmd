...
lapply(names(plts)[1],function(n){
    pdf(paste0("plots/13_2_markers_and_registration_final/01_2_LC3_reg_to_WebDiv_",n,"top5194.pdf"),height=8,width=10)
    print(plts[[n]])
    dev.off()
})
```
...
mapply(x=regs2,n=names(regs2),SIMPLIFY=FALSE,FUN=function(x,n){
   ...
   pdf(paste0("plots/13_2_markers_and_registration_final/01b_LC3_to_WebDiv_",n,".pdf"),height=8,width=10,onefile=TRUE)
   lapply(plts,print)
   dev.off()
})
```
