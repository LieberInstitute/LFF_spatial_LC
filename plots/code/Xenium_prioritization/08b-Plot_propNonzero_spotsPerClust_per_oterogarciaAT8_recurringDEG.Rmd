---
title: "08b-Plot_propNonzero_spotsPerClust_per_oterogarciaAT8_recurringDEG"
...
```{r}
clprop <- fread("processed-data/Xenium_prioritization/08a-ProportionSpots_per_clus_w_Oterogarcia22_multiclust_AT8DEGs.txt")
```
...
pdf("plots/Xenium_prioritization/08b-PropClusterSpots_xpr_oterogarciaAT8DEGs.pdf",height=4*ceiling(length(plts)/2),width=14)
