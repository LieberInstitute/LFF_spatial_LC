...
## sex de-simple
sexde <- readRDS("processed-data/08_XenDesign_Analyses/02a-glmPCA-snn10-louvs_sexDE_sexOnlyFactor.RDS")
names(sexde) #louv05, louv1

## sex DE covaried for E4 status and age
sexdecov <- readRDS("processed-data/08_XenDesign_Analyses/02b-glmPCA-snn10-louvs_sexDE_ageAPOEcovar.RDS")
names(sexdecov) # same
```
...
mapply(d=sexdel,s=spes,od=names(sexdel),SIMPLIFY = FALSE,FUN = function(d,s,od){
    if(!file.exists(paste0("plots/08_XenDesign_Analyses/02_sexDEGs/",od))){dir.create(paste0("plots/08_XenDesign_Analyses/02_sexDEGs/",od))}
    od2 <- paste0("plots/08_XenDesign_Analyses/02_sexDEGs/",od)
